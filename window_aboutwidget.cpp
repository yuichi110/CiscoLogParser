...
{
    #ifdef Q_WS_WIN
    setFixedSize(AppInfo::ABOUT_WINDOW_WIDTH_WINDOWS, AppInfo::ABOUT_WINDOW_HEIGHT_WINDOWS);
    #else
    setFixedSize(AppInfo::ABOUT_WINDOW_WIDTH_MAC, AppInfo::ABOUT_WINDOW_HEIGHT_MAC);
    #endif
